...
def checkout(request):
    ...
    return render(request,'checkout.html',{
        "cart_products":cart_products,"product_total":product_total,"total_quantity":total_quantity,"shipping_charges":shipping_charges,"gst_amt":gst_amt,"total_price":total_price})
