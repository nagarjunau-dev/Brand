...
def checkout(request):
    ...
    return render(request,'checkout.html',{"cart_products":cart_products,"subtotal":subtotal,"total_quantity":total_quantity})
...
def buynow(request):
    ...
    for i in items:
        gst +=i.quantity
        total += i.total_price
    return render(request,'buynow.html',{"cart_products":cart_products,"subtotal":subtotal,"total_quantity":total_quantity})